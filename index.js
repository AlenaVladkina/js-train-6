...
function copyObject(obj) {
  ...
  return animal2;// Повертаємо новий об'єкт
}
...
// Додаємо метод introduce до прототипу конструктора user
User.prototype.introduce = function() {
  return `My name is ${this.name} and I am ${this.age} years old.`;
};

// Створюємо екземпляр об'єкта user
...
function changeRole(array, newRole) {
  ...
  console.log(user);// Виводимо об'єкт на консоль
  }
}
...
function compareObjects(obj1, obj2) {
  ...
  obj2 = planet1;// Присвоємо obj2 значення об'єкту obj1
  console.log(obj1 === obj2);// Виводимо результат порівняння об'єктів
}
...
function addProperty(array) {
  // Додаємо нову властивість до прототипу Array зі значенням myProperty
...
// Створюємо масив newArr з новою властивістю за допомогою нашої функції, в яку передамо [1, 2, 3, 4, 5]
let newArr = addProperty([1, 2, 3, 4, 5]);
console.log(newArr); // Виведе [1, 2, 3, 4, 5]
